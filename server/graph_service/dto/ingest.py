...
class AddMessagesRequest(BaseModel):
    group_id: str = Field(
        ...,
        description='The unique identifier for the knowledge graph (group ID) to add the messages to',
    )
...
class AddEntityNodeRequest(BaseModel):
    ...
    group_id: str = Field(
        ...,
        description='The unique identifier for the knowledge graph (group ID) to add the node to',
    )
